            ...
            <div className='container'>
                <div className='row' >
                    ...
                    <div className='col-md-6 aboutright'>
                        ...
                        <p data-aos="fade-left" data-aos-duration="1000" data-aos-offset="300" >Hi, I'm Shantanu Saha, a Freelance MERN Stack Developer with 1 plus year of experience in both front-end and back-end development, and performing quality assurance. Excellent knowledge in using HTML5, CSS3, SASS, JavaScript, ReactJS, Bootstrap, MongoDB, MYSQL, ExpressJS,Node.JS, Figma, and Firebase. I care about writing clean code and genuinely love developing new applications and learning more.
                        </p>
                        <p data-aos="fade-left" data-aos-duration="1000"  data-aos-offset="300">I enjoy taking a complex project and turning it into simple yet beautiful websites with great user experience.</p>
